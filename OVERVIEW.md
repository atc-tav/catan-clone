...
A Settlers of Catan clone. React/Next.js + Three.js on the surface, but the heart
of the project is a **portable, framework-free TypeScript game core** designed to
be translated to C#/Unity later with minimal friction.

**Docs map**

- [`ARCHITECTURE.md`](./ARCHITECTURE.md) — the design and the Unity-port strategy.
- [`THREEJS-HOWTO.md`](./THREEJS-HOWTO.md) — a standalone, reusable guide to the
  React Three Fiber + procedural-geometry approach used here.
- [`DEVLOG.md`](./DEVLOG.md) — milestone-by-milestone history of the build.
- (`README.md` is intentionally just the project haiku.)
